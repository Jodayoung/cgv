...
for (let i=0; i<3; i++) {
    ...
    <div class="chart chart_${i})">
        <div class="poster">    
            <div class="sec sec1">
                <img src="./cgv/포스터/포스터${0+i*5}.jpg" alt="">
            </div>
            <div class="sec sec2">
                <img src="./cgv/포스터/포스터${1+i*5}.jpg" alt="">
            </div>
            <div class="sec sec3">
                <img src="./cgv/포스터/포스터${2+i*5}.jpg" alt="">
            </div>
            <div class="sec sec4">
                <img src="./cgv/포스터/포스터${3+i*5}.jpg" alt="">
            </div>
            <div class="sec sec5">
                <img src="./cgv/포스터/포스터${4+i*5}.jpg" alt="">
            </div>
        </div>
    </div>  
    `)}
